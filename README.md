...
- [V4：M2 日常播放器实施指导](docs/roadmap/netease-v4-m2-daily-player-plan.md)与[专用验证矩阵](docs/maintenance/netease-v4-m2-daily-player-verification.md)：待实施；歌单、共享队列、四模式、定位、歌词及按账号恢复，按 SOLID 分阶段推进
